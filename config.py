...
class DevelopmentConfig(Config):
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_DEV_URL') or 'sqlite:///' + os.path.join(basedir, 'data-dev.sqlite')
...
class ProductionConfig(Config):
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_PRO_URL') or 'sqlite:///' + os.path.join(basedir, 'data.sqlite')
